...
module Ferrum
  class Page
    module Frames
      ...
      private def subscribe_frame_attached
      ...
      private def subscribe_frame_detached
      ...
      private def subscribe_frame_started_loading
      ...
      private def subscribe_frame_navigated
        on("Page.frameNavigated") do |params|
          frame_id, name = params["frame"].try &.values_at("id", "name")
      ...
      private def subscribe_frame_stopped_loading
      ...
      private def subscribe_navigated_within_document
      ...
      private def subscribe_execution_context_created
      ...
      private def subscribe_execution_context_destroyed
        on("Runtime.executionContextDestroyed") do |params|
          ...
          frame.try &.execution_id = nil
        end
      end

      private def subscribe_execution_contexts_cleared
