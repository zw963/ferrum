module Ferrum
  ...
  class PendingConnectionsError < StatusError
    ...
    def initialize(url, @pendings = [] of String)
  ...
  class NodeMovingError < Error
    def initialize(@node : BlackHole, @prev : BlackHole, @current : BlackHole)
      super(message)
    end
  ...
  class BrowserError < Error
    getter response : Hash(String, String)
  ...
  class JavaScriptError < BrowserError
    getter :class_name, :message, stack_trace : BlackHole?
