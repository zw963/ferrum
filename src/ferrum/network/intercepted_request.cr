...
module Ferrum
  class Network
    class InterceptedRequest
      property :request_id, :frame_id, :resource_type, :network_id, :status
      ...
      def respond(**options)
        ...
        headers = has_body ? {"content-length" => options.fetch(:body, "").length} : {} of BlackHole => BlackHole
        headers = headers.merge(options.fetch(:responseHeaders, {} of BlackHole => BlackHole))
